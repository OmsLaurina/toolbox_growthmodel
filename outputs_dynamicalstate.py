...
if nbpulse == 3 : 
    [Psupply_dyn,arg] = pulsedflux_stepfunction(time_flux, A=b,C=Psupply_cst, pulsations=[{'t1': 5, 't2': 10},{'t1': 20, 't2': 25},{'t1': 35, 't2': 40}])
if nbpulse == 2 : 
    [Psupply_dyn,arg] = pulsedflux_stepfunction(time_flux, A=b,C=Psupply_cst, pulsations=[{'t1': 5, 't2': 10},{'t1': 20, 't2': 25}])
if nbpulse == 1 : 
    [Psupply_dyn,arg] = pulsedflux_stepfunction(time_flux, A=b,C=Psupply_cst, pulsations=[{'t1': 5, 't2': 10}])  
...
[P1,P2,Z,PO4,arg]=growth_model_2P1Z_v10(Psupply_dyn,time_flux,dt,P1_ini=P1_new,P2_ini=P2_new,Z_ini=Z_new,PO4_ini=PO4_new)
